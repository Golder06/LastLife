...
public class ObsoleteStartCommand {
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        ...
        dispatcher.register(literal("startsession").requires(cs -> cs.hasPermissionLevel(2))
                .executes((command) -> {
                            ...
                            Identifier id = new Identifier("lastlife", "startsession");
                            /*
                            Collection<CommandFunction> function = new CommandFunction(, id); // .getFunctions(command, "lastlife:startsession");
